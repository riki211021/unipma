      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="group backdrop-blur-sm bg-white/80 rounded-xl border border-gray-100 hover:border-cyan-200 shadow-md hover:shadow-xl p-6 transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <section className="mb-16">
          ...
          <div className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="group backdrop-blur-sm bg-white/80 rounded-xl border border-gray-100 hover:border-cyan-200 shadow-md hover:shadow-xl p-5 transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="flex items-start justify-between gap-2">
                    <p className="text-gray-800 font-medium leading-snug group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-600 group-hover:to-blue-600 transition-all">
                      {prodi}
          ...
          <div className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {["Akuntansi", "Manajemen", "Perpajakan"].map((prodi, index) => (
                <div
                  key={index}
                  className="group backdrop-blur-sm bg-white/80 rounded-xl border border-gray-100 hover:border-cyan-200 shadow-md hover:shadow-xl p-5 transition-all duration-300 hover:-translate-y-1"
                >
          ...
          <div className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {["Farmasi", "Ilmu Keolahragaan"].map((prodi, index) => (
                <div
                  key={index}
                  className="group backdrop-blur-sm bg-white/80 rounded-xl border border-gray-100 hover:border-cyan-200 shadow-md hover:shadow-xl p-5 transition-all duration-300 hover:-translate-y-1"
                >
        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {["D3 Manajemen Pajak"].map((prodi, index) => (
              <div
                key={index}
                className="group backdrop-blur-sm bg-white/80 rounded-xl border border-gray-100 hover:border-cyan-200 shadow-md hover:shadow-xl p-5 transition-all duration-300 hover:-translate-y-1"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="backdrop-blur-sm bg-white/60 border border-gray-100 rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600 mb-2">40+</div>
            <p className="text-gray-600 font-medium">Program Studi</p>
          </div>
          
          <div className="backdrop-blur-sm bg-white/60 border border-gray-100 rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-2">5</div>
