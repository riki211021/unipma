...
import { Award, FileCheck, BookOpen, DollarSign, BookMarked, ChevronRight } from "lucide-react";

export default function JalurPendaftaran() {
  const jalurs = [
    {
      title: "Jalur PMDK (Tanpa Tes)",
      description: "Seleksi berdasarkan nilai rapor semester I-V. Jalur ini berlaku bagi siswa yang lulus tahun 2024 dan yang akan lulus tahun 2025.",
      icon: Award,
      gradient: "from-cyan-400 to-blue-500",
    },
    {
      title: "Jalur PNUAN (Tanpa Tes)",
      description: "Seleksi berdasarkan nilai UAN/STTB/Ijazah. Jalur ini berlaku bagi siswa yang lulus tahun 2023 dan sebelumnya.",
      icon: FileCheck,
      gradient: "from-blue-400 to-indigo-500",
    },
    {
      title: "Jalur Bebas Tes (SKL/IJAZAH/UTBK)",
      description: "Jalur ini diperuntukkan bagi pendaftar dengan kriteria seperti siswa yang telah lulus tahun 2024 tetapi belum diterbitkan SKHUN, yang akan menggunakan Surat Keterangan Lulus (SKL) dari kepala sekolah.",
      icon: BookOpen,
      gradient: "from-cyan-500 to-teal-500",
    },
    {
      title: "Beasiswa KIP-Kuliah",
      description: "Merupakan jalur pendaftaran khusus bagi calon mahasiswa yang memenuhi syarat untuk mendapatkan beasiswa kuliah tanpa biaya besar.",
      icon: DollarSign,
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      title: "Jalur Hafids Quran",
      description: "Jalur khusus bagi pendaftar yang memiliki hafalan Al-Qur'an sesuai kriteria yang ditentukan oleh Universitas PGRI Madiun.",
      icon: BookMarked,
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 text-center md:text-left space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light text-gray-900">
            Jalur Pendaftaran <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600">PMB UNIPMA</span>
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {jalurs.map((jalur, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative backdrop-blur-sm bg-white/80 rounded-2xl p-8 border border-gray-100 hover:border-cyan-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              >
                {/* Gradient Overlay */}
          ...
          <div className="backdrop-blur-sm bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-200/50 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div className="text-center md:text-left">
                <p className="text-lg font-semibold text-gray-900">Butuh bantuan memilih jalur?</p>
                <p className="text-gray-600 font-light">Konsultasi gratis dengan tim PMB kami</p>
              </div>
            </div>
            <a 
              href="#kontak"
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="backdrop-blur-sm bg-white/60 border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-gray-900">5 Jalur</h4>
            </div>
            <p className="text-sm text-gray-600 font-light">Pilihan jalur pendaftaran yang fleksibel</p>
          </div>
          ...
          <div className="backdrop-blur-sm bg-white/60 border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-gray-900">Tanpa Tes</h4>
            </div>
            <p className="text-sm text-gray-600 font-light">Beberapa jalur tersedia tanpa ujian</p>
          </div>
          ...
          <div className="backdrop-blur-sm bg-white/60 border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-gray-900">Beasiswa</h4>
            </div>
            <p className="text-sm text-gray-600 font-light">Tersedia jalur KIP-Kuliah dan beasiswa</p>
          </div>
        </div>

        {/* Additional Info Banner */}
        <div className="mt-12 backdrop-blur-sm bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-100 rounded-2xl p-6">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
              <BookOpen className="w-5 h-5 text-white" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Informasi Penting</h4>
              <p className="text-sm text-gray-600 leading-relaxed font-light">
                Setiap jalur memiliki persyaratan dan ketentuan yang berbeda. Pastikan Anda membaca dengan teliti persyaratan setiap jalur sebelum mendaftar. Untuk informasi lebih detail, silakan hubungi tim PMB kami atau kunjungi halaman resmi pendaftaran.
              </p>
            </div>
          </div>
        </div>
