...
import { Church, Building2, Home, LampDesk, Sparkles, ChevronRight } from "lucide-react";
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {ibadahList.map((item, index) => {
          ...
          return (
            <div
              key={index}
              onClick={() => navigate(`/ibadah/${item.id}`)}
            ...
            >
              ...
              <div className="relative overflow-hidden h-64">
                ...
                <img src={item.gambar} alt={item.nama} className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700" />
              </div>
              ...
              <div className="p-6 space-y-3">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-cyan-500 group-hover:translate-x-1 transition-all duration-300 mt-1" />
                </div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span className="font-light">Tempat ibadah nyaman & bersih</span>
                </div>
              </div>
