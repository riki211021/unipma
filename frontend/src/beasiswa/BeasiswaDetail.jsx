...
export default function BeasiswaDetail() {
  ...
  const beasiswaList = {
    kip: {
      ...
      syarat: [
        "Terdaftar di DTKS / Surat Keterangan Tidak Mampu",
        "Lulus seleksi masuk UNIPMA",
        "Mengisi formulir pendaftaran KIP Kuliah",
      ],
    },
    berprestasi: {
    ...
    unggulan: {
      ...
      gambar: prestasiImg,
      deskripsi:
        "Beasiswa unggulan diberikan kepada mahasiswa baru berprestasi dengan nilai akademik tinggi.",
    ...
    pgri: {
      ...
      gambar: keluargaImg,
      deskripsi:
        "Beasiswa khusus bagi anak anggota PGRI untuk mendukung keberlanjutan pendidikan di UNIPMA.",
    ...
    mitra: {
      ...
      gambar: guruImg,
      deskripsi:
        "Beasiswa untuk siswa dari sekolah yang telah bekerja sama dengan UNIPMA.",
    ...
    ntt: {
      ...
      gambar: beasiswa7Img,
      deskripsi:
        "Beasiswa khusus diberikan untuk mahasiswa asal Nusa Tenggara Timur (NTT).",
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-cyan-50 to-blue-100 py-16 px-6 md:px-12">
      ...
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 mb-10 text-gray-700 hover:text-cyan-600 transition-colors"
      >
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="p-10 space-y-10">
          ...
          <div className="text-center mt-12">
            <a
              href="#kontak"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-3 rounded-xl text-lg font-semibold shadow-lg hover:scale-105 hover:shadow-cyan-500/30 transition-all"
            >
